...
class rms
{
	public $base_url = 'http://localhost/res/';
	public $connect;
	public $query;
	public $statement;
	public $cur;
	...
	function __construct()
	{
		...
		$this->connect = new PDO('mysql:host=localhost;dbname=rms;charset=utf8', 'root', '', array(PDO::ATTR_ERRMODE => PDO::ERRMODE_EXCEPTION));
	...
	{
		$html = '
		<select name="restaurant_currency" id="restaurant_currency" class="form-control" >
